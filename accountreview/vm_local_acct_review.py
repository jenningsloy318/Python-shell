...
def cmdgen():
    ...
    cmd_lastlog='last -F'+'|'+'grep -E -v "down|eboot"'+'|'+'grep -E "'+grep_year+'"'+'|'+'awk '''''{print $1,$8"-"$5}'''+"'"+'|grep -E "'+grep_month+'"'+'|sort -k1|'+'awk '''''{print $1}'''+"'"+'|uniq -c|'+'awk '''''{print $2":"$1}'''+"'"
    cmd_lastlog_accts='login_accts=`last -F'+'|'+'grep -E -v "down|eboot"'+'|'+'grep -E "'+grep_year+'"'+'|'+'awk '''''{print $1,$8"-"$5}'''+"'"+'|grep -E "'+grep_month+'"'+'|sort -k1|'+'awk '''''{print $1}'''+"'"+'|uniq -c|'+'awk '''''{print $2}'''+"'`"
