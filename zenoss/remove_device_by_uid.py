...
arguments.add_argument("-f","--hostslist", nargs="?",help="The hosts list which will be deleted from zenoss")
if len(sys.argv) ==1:
...
for line in open(host_list):
    ...
    operation_result=newsession.router_request('DeviceRouter', 'removeDevices',data=[{'uids':uid,'hashcheck':'','action':'delete'}])['result']
