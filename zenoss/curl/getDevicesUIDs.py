...
operation_result=newsession.operate('DeviceRouter','getDevices',data)
#print(operation_result['result']['devices'])
#devlist=operation_result.keys()
devlist=operation_result['result']['devices']
